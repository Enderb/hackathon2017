...
class Composer:
    ...
    def _parse_args(args):
        ...
        dataset_args.add_argument('--dataset_tag', type=str, default='ragtime', help='tag to differentiate which data use (if the data are not present, the program will try to generate from the midi folder)')
